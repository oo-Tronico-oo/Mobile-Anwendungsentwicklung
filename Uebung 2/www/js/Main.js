...
requirejs.config({
    ...
    paths: {
        ...
        ReadviewRactiveViewController: 'js/controller/ReadviewRactiveViewController',
...
requirejs(["mwf", "GenericDialogTemplateViewController", "MyApplication", "MyInitialViewController", "ListviewViewController", "ReadviewRactiveViewController" /*"ReadviewViewController"*/, "EditviewViewController"],
    function (mwf) {
